...
import EventDetailComp from "../../ShowpromoterHome/EventDetailComp";
    ...
    <>
      {isEvent ? (
        ...
        <div className="mt-4 px-6 w-full min-w-screen font-general">
          <Navbar />
          <div className="flex flex-col gap-6 w-full max-h-[calc(100vh-90px)] py-2 h-full overflow-y-scroll">
            ...
            <div
              className="w-full shrink-0 rounded-2xl shadow-thumbShadow bg-[#ebebeb] p-3 overflow-hidden relative"
            ...
            >
              ...
              <div className="h-[272px] w-full">
                <div className="bg-event1 bg-cover bg-right w-full h-full object-cover object-center rounded-2xl" />
              </div>
              <div className="w-full p-5 gap-4 flex flex-col bg-white rounded-2xl mt-4">
                <div className="w-full flex flex-col gap-1">
                  <div className="w-full flex items-center justify-between">
                    ...
                    <p className="text-[#7c7c7c] text-[8px]">status</p>
                  </div>
                  <div className="w-full flex items-center justify-between">
                ...
                <button className="w-full flex items-center justify-center py-4 rounded-2xl border border-black text-white bg-black font-semibold">
                  View details
                </button>
              </div>
            </div>
          ...
          >
            <div className="flex flex-col min-w-screen text-[#141414] relative py-6">
              ...
              <div className="grid grid-cols-3 w-full gap-4 pt-2 mb-5">
                <div className="py-2 px-3 rounded-[20px] text-[#fff] text-nowrap text-xs bg-[#000] leading-5 text-center">
                  Club events
                </div>
                <div className="py-2 px-3 rounded-[20px] text-[#5F5F63] text-nowrap text-xs bg-[#e8e8e8] leading-5 text-center">
                  Church events
                </div>
                <div className="py-2 px-3 rounded-[20px] text-[#101013] text-nowrap text-xs bg-[#e8e8e8] leading-5 text-center">
                  Concert
                </div>
                <div className="py-2 px-3 rounded-[20px] text-[#5F5F63] text-nowrap text-xs bg-[#e8e8e8] leading-5 text-center">
                  20 Applied
