    ...
    <>
      {isCode ? (
        <div className='px-5 font-general flex flex-col items-center w-full max-w-[768px] mx-auto justify-between py-10 text-black min-h-screen h-full'>
          <div className='flex flex-col items-center'>
            ...
            <div className='flex flex-col items-center gap-3 mb-5'>
              ...
              <p className='text-sm text-[#0000007D] text-center'>An Email with the 4 digits code has been sent to your email <span className='text-black italic'>{formData.email}</span></p>
            </div>
        ...
        <div className='px-5 font-general flex flex-col items-center w-full max-w-[768px] mx-auto justify-center py-10 text-black'>
          ...
          <form onSubmit={handleSubmit} className='flex flex-col w-full items-center gap-6 text-sm mb-7'>
            <input 
