        ...
        >
          <div className=" pt-32 pb-10 flex flex-col w-full items-center">
            ...
            <div className="flex flex-col gap-6 text-sm w-full mb-8">
              <input
                className="p-4 border border-grayBord rounded-2xl w-full placeholder:text-[rgba(0,0,0,0.7)]"
                placeholder="Email"
              />
              <input
                className="p-4 border border-grayBord rounded-2xl w-full placeholder:text-[rgba(0,0,0,0.7)]"
              ...
              <Link
                to="/home"
                className="text-white py-5 w-full text-base font-semibold bg-greenBlue rounded-2xl text-center"
              >
                Continue
              </Link>
            </div>
