  ...
  return (
    ...
    <div className='mt-4 px-6 w-full min-w-screen font-general relative'>
      <div className='fixed z-10 bg-white w-full bottom-0 left-0 right-0 px-6 shadow-menuShadow pt-2 pb-6 grid grid-cols-5'>
        <Link to='/showhome' className={`${location.pathname == '/home' ? '' : 'opacity-70' } flex flex-col items-center gap-1`}>
          <HomeIcon />
        ...
        <Link to='/showevents' className={`${location.pathname == '/events' ? '' : 'opacity-70' } flex flex-col items-center gap-1`}>
          <EventsIcon />
          <p className='text-xs font-bold text-black'>Events</p>
        </Link>
        <Link to='/showfavorites' className={`${location.pathname == '/favorites' ? '' : 'opacity-70' } flex flex-col items-center gap-1`}>
          <FavoritesIcon />
